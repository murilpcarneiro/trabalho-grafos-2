...
Problema Simulado: Sistema de Navegação entre Cidades
- Encontrar o caminho mais curto entre duas cidades
- Calcular a distância mínima (número de cidades intermediárias)
- Visualizar o caminho completo da origem ao destino
...
from collections import deque  # Fila para implementação do BFS
from typing import Dict, List, Set, Tuple, Optional


class GrafoCidades:
    """
    Classe que representa um grafo de cidades conectadas por estradas.
    
    Estrutura de Dados:
    - Grafo não-direcionado (estradas de mão dupla)
    - Representado por lista de adjacências
    - Cada vértice representa uma cidade
    - Cada aresta representa uma conexão direta entre cidades
    """
    ...
    def __init__(self):
        ...
        Atributos:
        - grafo: dicionário onde a chave é a cidade e o valor é uma lista
                 de cidades vizinhas (adjacentes)
        """
    ...
    def adicionar_cidade(self, cidade: str) -> None:
        ...
        Args:
            cidade: Nome da cidade a ser adicionada
        """
    ...
    def adicionar_estrada(self, cidade1: str, cidade2: str) -> None:
        ...
        Args:
            cidade1: Primeira cidade
            cidade2: Segunda cidade
        
        Nota: Como é um grafo não-direcionado, a conexão é adicionada
              nas duas direções (cidade1 -> cidade2 e cidade2 -> cidade1)
        """
        # Garante que ambas as cidades existem no grafo
    ...
    def bfs_caminho_mais_curto(self, origem: str, destino: str) -> Optional[Tuple[List[str], int]]:
        ...
        1. Começa pela cidade de origem
        2. Explora todos os vizinhos diretos (nível 1)
        3. Depois explora os vizinhos dos vizinhos (nível 2)
        4. Continua expandindo em "camadas" até encontrar o destino
        5. Garante encontrar o caminho com menor número de conexões
        
        ESTRUTURAS DE DADOS UTILIZADAS:
        - Fila (deque): para processar cidades na ordem FIFO (First In, First Out)
        - Set (visitados): para marcar cidades já exploradas
        - Dict (pais): para reconstruir o caminho após encontrar o destino
        ...
        Returns:
            Tupla contendo:
            - Lista com o caminho (sequência de cidades)
            - Distância (número de conexões)
    ...
    def exibir_resultado(self, origem: str, destino: str) -> None:
        """
        Executa o BFS e exibe o resultado de forma formatada.
...
def criar_mapa_brasil() -> GrafoCidades:
    """
    Cria um mapa com cidades brasileiras e suas conexões.
    
    O grafo possui:
    - 20 cidades (vértices) - mais que o mínimo de 16 exigido
    - Conexões representando estradas entre cidades
    - Estrutura que permite diversos caminhos diferentes
    
    Returns:
        Objeto GrafoCidades configurado
    """
    print("\n" + "="*70)
...
def menu_principal():
    """
    Interface principal do programa com menu interativo.
    """
    print("\n" + "="*70)
