"""
Script para gerar uma visualização gráfica do mapa de cidades.
Este é um EXTRA opcional que você pode usar para tornar a apresentação mais visual.

NOTA: Requer instalação de bibliotecas adicionais:
...
def desenhar_mapa(destacar_caminho=None):
    """
    Desenha o mapa de cidades como um grafo visual.
    
    Args:
        destacar_caminho: Lista de cidades para destacar (opcional)
    """
...
if __name__ == "__main__":
    ...
    INSTRUÇÕES:
    1. Instale as dependências: pip install matplotlib networkx
    2. Execute: python visualizar_grafo.py
    3. Escolha uma opção de visualização
    4. A imagem será salva e mostrada na tela
    """
